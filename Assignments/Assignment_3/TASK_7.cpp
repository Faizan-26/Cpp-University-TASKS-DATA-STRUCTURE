...
//    }
//
//    void getKthLargest(AvlNode* Root, int k) {
//    int cur = 0;
//    AvlNode* kthNode = getkthNode(Root, k, cur);
//    if (!kthNode) {
//        cout << "Nodes in tree are less than k"<<endl;
//    }
//    else {
//        cout << "Your kth largest element is :" << kthNode->data << endl;
//    }
//    }
//    AvlNode* getkthNode(AvlNode* Root, int k, int cur) {
//        if (Root == NULL || cur >= k) {
//            return NULL;
//        }
//        AvlNode* rightNode = getkthNode(Root->right, k, cur);
//        if (rightNode) {
//            return rightNode;
//        }
//        if (++cur == k) {
//            return Root;
//        }
//        return getkthNode(Root->left, k, cur);
//    }
