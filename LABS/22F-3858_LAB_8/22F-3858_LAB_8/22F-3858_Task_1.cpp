...
//    RankingSystem.getTopPlayers(RankingSystem.getRootNode(), num);
//
//    int playerId, updatedScore;
//    cout << "Enter Player Id to update: ";
//    cin >> playerId;
//    cout << "Enter Score to update: ";
//    cin >> updatedScore;
//
//    RankingSystem.updateScore(playerId, updatedScore);
//    cout << "Player " << playerId << " updated to score " << updatedScore << endl;
//    cout << "Enter Number of top players to display: ";
//    int newnum;
//    cin >> newnum;
//    cout << "\nUpdated Top Players:" << endl;
//    RankingSystem.getTopPlayers(RankingSystem.getRootNode(), newnum);
//
//    return 0;
//}
