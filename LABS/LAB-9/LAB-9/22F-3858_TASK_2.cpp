...
//    cout << "\nInserting AVL TREE :\n";
//    
//    avl2.insert(10, avl2.getRoot());
//    avl2.insert(4, avl2.getRoot());
//    avl2.insert(13, avl2.getRoot());
//    avl2.insert(3, avl2.getRoot());
//    avl2.insert(8, avl2.getRoot());
//    avl2.insert(20, avl2.getRoot());
//    avl2.insert(11, avl2.getRoot());
//    is_AVL = false;
//    avl2.isAVL(avl2.getRoot(), is_AVL);
//    if (is_AVL) {
//        cout << "Your Tree is AVL.\n";
//    }
//    else {
